...
**📥 [下载 Windows 版 EXE](https://github.com/qj739/hearthstone-lethal-helper/releases/download/v1.0.6/HS-Lethal-Helper.exe)** · **🎬 [观看功能演示视频](https://github.com/qj739/hearthstone-lethal-helper/raw/main/assets/demo/arena-lethal-demo.mp4)**
...
| | |
|---|---|
| **Windows 免安装版** | [HS-Lethal-Helper.exe](https://github.com/qj739/hearthstone-lethal-helper/releases/download/v1.0.6/HS-Lethal-Helper.exe)（解压即用，首次运行后重启炉石） |
...
| | |
|---|---|
| **Windows build** | [HS-Lethal-Helper.exe](https://github.com/qj739/hearthstone-lethal-helper/releases/download/v1.0.6/HS-Lethal-Helper.exe) (no install; restart Hearthstone after first run) |
